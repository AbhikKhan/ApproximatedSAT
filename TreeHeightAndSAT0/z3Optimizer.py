...
s.add(R_1_4 == (4**H_2)*x_1_4+W_2_1*R_2_4)
s.add(R_2_1 == (4**H_3)*x_2_1+W_3_2*R_3_1)
s.add(R_2_2 == (4**H_3)*x_2_2+W_3_2*R_3_2)
s.add(R_2_3 == (4**H_3)*x_2_3+W_3_2*R_3_3)
s.add(R_2_4 == (4**H_3)*x_2_4+W_3_2*R_3_4)
s.add(R_3_1 == (4**H_4)*x_3_1+W_4_3*R_4_1)
s.add(R_3_2 == (4**H_4)*x_3_2+W_4_3*R_4_2)
s.add(R_3_3 == (4**H_4)*x_3_3+W_4_3*R_4_3)
s.add(R_3_4 == (4**H_4)*x_3_4+W_4_3*R_4_4)
s.add(R_4_1 == x_4_1)
s.add(R_4_2 == x_4_2)
s.add(R_4_3 == x_4_3)
s.add(R_4_4 == x_4_4)
...
s.add(0.3*(4**H_1) - R_1_1 <= 0.007*(4**H_1))
s.add(R_1_1 - 0.3*(4**H_1) <= 0.007*(4**H_1))
s.add(0.23*(4**H_1) - R_1_2 <= 0.007*(4**H_1))
s.add(R_1_2 - 0.23*(4**H_1) <= 0.007*(4**H_1))
s.add(0.24*(4**H_1) - R_1_3 <= 0.007*(4**H_1))
s.add(R_1_3 - 0.24*(4**H_1) <= 0.007*(4**H_1))
s.add(0.23*(4**H_1) - R_1_4 <= 0.007*(4**H_1))
s.add(R_1_4 - 0.23*(4**H_1) <= 0.007*(4**H_1))
