...
s.add(0.3*(4**4) - R_1_1 <= 0.007*(4**4))
s.add(R_1_1 - 0.3*(4**4) <= 0.007*(4**4))
s.add(0.31*(4**4) - R_1_2 <= 0.007*(4**4))
s.add(R_1_2 - 0.31*(4**4) <= 0.007*(4**4))
s.add(0.2*(4**4) - R_1_3 <= 0.007*(4**4))
s.add(R_1_3 - 0.2*(4**4) <= 0.007*(4**4))
s.add(0.19*(4**4) - R_1_4 <= 0.007*(4**4))
s.add(R_1_4 - 0.19*(4**4) <= 0.007*(4**4))

startTime = time.time()
fp = open('z3outputFile29','w')
if s.check() == sat:
	lst = s.model()
	for i in lst:
