...
s.add(x_1_1+x_1_2+x_1_3+x_1_4+W_2_1==4)
s.add(x_2_1+x_2_2+x_2_3+x_2_4+W_3_2==4)
s.add(x_3_1+x_3_2+x_3_3+x_3_4+W_4_3==4)
s.add(x_4_1+x_4_2+x_4_3+x_4_4==4)
...
s.add(0.18*(4**4) - R_1_1 <= 0.006*(4**4))
s.add(R_1_1 - 0.18*(4**4) <= 0.006*(4**4))
s.add(0.39*(4**4) - R_1_2 <= 0.006*(4**4))
s.add(R_1_2 - 0.39*(4**4) <= 0.006*(4**4))
s.add(0.23*(4**4) - R_1_3 <= 0.006*(4**4))
s.add(R_1_3 - 0.23*(4**4) <= 0.006*(4**4))
s.add(0.2*(4**4) - R_1_4 <= 0.006*(4**4))
s.add(R_1_4 - 0.2*(4**4) <= 0.006*(4**4))

startTime = time.time()
fp = open('z3outputFile6','w')
if s.check() == sat:
	lst = s.model()
	for i in lst:
