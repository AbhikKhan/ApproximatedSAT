...
s.add(0.4375*(4**3) - R_1_1 <= 0.0047*(4**3))
s.add(R_1_1 - 0.4375*(4**3) <= 0.0047*(4**3))
s.add(0.203125*(4**3) - R_1_2 <= 0.0047*(4**3))
s.add(R_1_2 - 0.203125*(4**3) <= 0.0047*(4**3))
s.add(0.359375*(4**3) - R_1_3 <= 0.0047*(4**3))
s.add(R_1_3 - 0.359375*(4**3) <= 0.0047*(4**3))

startTime = time.time()
fp = open('./z3OutputFiles/z3outputFile31','w')
if s.check() == sat:
	lst = s.model()
	for i in lst:
