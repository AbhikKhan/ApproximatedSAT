...
s.add(0.3037109375*(4**5) - R_1_1 <= 0.0039*(4**5))
s.add(R_1_1 - 0.3037109375*(4**5) <= 0.0039*(4**5))
s.add(0.078125*(4**5) - R_1_2 <= 0.0039*(4**5))
s.add(R_1_2 - 0.078125*(4**5) <= 0.0039*(4**5))
s.add(0.080078125*(4**5) - R_1_3 <= 0.0039*(4**5))
s.add(R_1_3 - 0.080078125*(4**5) <= 0.0039*(4**5))
s.add(0.0791015625*(4**5) - R_1_4 <= 0.0039*(4**5))
s.add(R_1_4 - 0.0791015625*(4**5) <= 0.0039*(4**5))
s.add(0.458984375*(4**5) - R_1_5 <= 0.0039*(4**5))
s.add(R_1_5 - 0.458984375*(4**5) <= 0.0039*(4**5))

startTime = time.time()
fp = open('./z3OutputFiles/z3outputFile1328','w')
if s.check() == sat:
	lst = s.model()
	for i in lst:
