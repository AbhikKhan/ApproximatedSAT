...
s.add(0.0341796875*(4**5) - R_1_1 <= 0.0031*(4**5))
s.add(R_1_1 - 0.0341796875*(4**5) <= 0.0031*(4**5))
s.add(0.0078125*(4**5) - R_1_2 <= 0.0031*(4**5))
s.add(R_1_2 - 0.0078125*(4**5) <= 0.0031*(4**5))
s.add(0.0224609375*(4**5) - R_1_3 <= 0.0031*(4**5))
s.add(R_1_3 - 0.0224609375*(4**5) <= 0.0031*(4**5))
s.add(0.0341796875*(4**5) - R_1_4 <= 0.0031*(4**5))
s.add(R_1_4 - 0.0341796875*(4**5) <= 0.0031*(4**5))
s.add(0.9013671875*(4**5) - R_1_5 <= 0.0031*(4**5))
s.add(R_1_5 - 0.9013671875*(4**5) <= 0.0031*(4**5))

startTime = time.time()
fp = open('./z3OutputFiles/z3outputFile1549','w')
if s.check() == sat:
	lst = s.model()
	for i in lst:
